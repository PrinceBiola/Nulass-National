...
function Communication() {
  ...
  const sendNotification = () => {
    ...
    console.log(`Sending ${notification.contactMethod} notification to ${notification.targetGroup}: ${notification.message}`);
    setNotification({ message: '', targetGroup: 'all', contactMethod: 'email' }); // Reset form
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="mb-4">
          ...
          <select
            ...
            onChange={(e) => setNotification({ ...notification, targetGroup: e.target.value })}
        ...
        <div className="mb-4">
          ...
          <select
            ...
            onChange={(e) => setNotification({ ...notification, contactMethod: e.target.value })}
            className="border rounded-lg p-2"
          >
        ...
        <button onClick={sendNotification} className="bg-blue-600 text-white rounded-lg p-2">Send Notification</button>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        />
        <button onClick={addFeedback} className="bg-blue-600 text-white rounded-lg p-2">Submit Feedback</button>
