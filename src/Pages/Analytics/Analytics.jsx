  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <button onClick={fetchTrafficData} className="bg-blue-600 text-white rounded-lg p-2 mb-4">Fetch Traffic Data</button>
        ...
        <ul className="list-disc pl-5">
          {trafficData.demographics.map((demo, index) => (
            <li key={index}>{demo.ageGroup}: {demo.percentage}%</li>
          ))}
        </ul>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <button onClick={fetchMemberEngagement} className="bg-blue-600 text-white rounded-lg p-2 mb-4">Fetch Engagement Data</button>
        ...
        <ul className="list-disc pl-5">
          {memberEngagement.interactions.map((interaction, index) => (
            <li key={index}>{interaction.member}: {interaction.actions} actions</li>
          ))}
        </ul>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <button onClick={fetchEventMetrics} className="bg-blue-600 text-white rounded-lg p-2 mb-4">Fetch Event Metrics</button>
        ...
        <ul className="list-disc pl-5">
          {eventMetrics.feedbackRatings.map((feedback, index) => (
            <li key={index}>{feedback.event}: {feedback.rating} stars</li>
          ))}
        </ul>
      </div>
    </div>
